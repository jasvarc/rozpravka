...
- pocas citania sa (ak to rodic povoli checkboxom) prehravaju kratke zvukove efekty na kluucove slova v texte (dazd, kacka, vlak, pes, macka, vtak, hrom, ohen, zvonček, sova, kon, krava, ovca, hodiny...), max. raz za 2-3 vety. Zvuky su syntetizovane priamo v prehliadaci (Web Audio API), ziadny externy zvukovy subor ani API
