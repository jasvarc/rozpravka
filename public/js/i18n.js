const TRANSLATIONS = {
  sk: {
    ...
    dieta_error_voice_permission: 'Prehliadač nemá povolený prístup k mikrofónu. Over v nastaveniach prehliadača, či je pre túto stránku mikrofón povolený.',
    ...
    child_moral_lesson_pending: '📝 pripravené mravné ponaučenie',
    ...
    moral_lesson_label: 'Mravné ponaučenie pre nasledujúcu rozprávku tohto dieťaťa (nechaj prázdne, ak žiadne nechceš)',
    moral_lesson_placeholder: 'napr. je dôležité deliť sa s kamarátmi',
    moral_lesson_hint: 'Po vygenerovaní najbližšej rozprávky tohto dieťaťa sa toto pole samo vyprázdni.',
  ...
  en: {
    ...
    dieta_error_voice_permission: "The browser doesn't have microphone access. Check your browser's site settings to make sure the microphone is allowed for this page.",
    ...
    child_moral_lesson_pending: '📝 moral lesson ready',
    ...
    moral_lesson_label: "Moral lesson for this child's next story (leave empty if you don't want one)",
    moral_lesson_placeholder: "e.g. it's important to share with friends",
    moral_lesson_hint: "This field clears itself automatically once this child's next story is generated.",
